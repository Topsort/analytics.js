test("check clicks", async () => {
  ...
  document.body.innerHTML = `
    <div id="product" data-ts-product="product-id-click-1" data-ts-resolved-bid="1247eaae-63a1-4c20-9b52-9efdcdef3095"><div id="clickable1" data-ts-clickable>Clickable 1</div><div id="non-clickable">Non clickable Text</div><div id="clickable2" data-ts-clickable>Clickable 2</div></div>
  `;
